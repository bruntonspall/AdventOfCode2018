...
class TestBasic(unittest.TestCase):
    ...
    def test_simple_solve(self):
        ...
        self.assertEqual(99, puzzle.solve({"metadata": [1], "children": [
            {"metadata": [99], "children": []},
            {"metadata": [71], "children": []}
        ]}))
        self.assertEqual(71, puzzle.solve({"metadata": [2], "children": [
            {"metadata": [99], "children": []},
            {"metadata": [71], "children": []}
        ]}))
        self.assertEqual(198, puzzle.solve({"metadata": [1, 1], "children": [
            {"metadata": [99], "children": []},
            {"metadata": [71], "children": []}
        ]}))
        self.assertEqual(106, puzzle.solve({"metadata": [1, 2], "children": [
            {"metadata": [99], "children": []},
            {"metadata": [1], "children": [
                {"metadata": [7], "children": []},
            ]}
